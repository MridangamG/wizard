...
import children from '../images/childern.jpg'
import ciggrets from '../images/ciggrets.jpeg'
import region from '../images/regiion.jpg'
...
const Form = () => {
    ...
    const handleSubmit = async(e)=>{
        ...
        console.log(data)
        const res = await axios.post('https://backend-kfsn.onrender.com/api',data);
    ...
    return (
        ...
        <form className='form' onSubmit={handleSubmit}>
            ...
            <img src={`${bmi}`}/>
            <h1 className='form_heading'>What is your BMI(body mass index):</h1>
            ...
            <h1 className='form_heading'>DO YOU SMOKE ? </h1>
            <select className='select' onChange={setSmoker}>
                ...
                <img src={`${region}`}/>
                <h1 className='form_heading'>From which region you belong to?</h1>
                ...
                <button type='submit' className='button'>CAST THE SPELL</button>
                <div>
                {loading ? 
                        <div>calulating the cost...... PLEASE WAIT</div>
                        :
                        recievedData?
                        <div>The Estimated money required is RUPEES  {recievedData}</div>:
                        <div></div>
                }
                </div>
            </form>
